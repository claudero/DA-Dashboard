...
class Column extends React.Component {
  static propTypes = {
    ...
    /**
     * Custom cell tooltip content
     * The callback is of the shape of `({ cellData, column, columnIndex, rowData, rowIndex }) => node`
     */
     ...
     * The callback is of the shape of `({ column, columnIndex, container }) => *`
     */
    renderHeader: PropTypes.func,
    /**
     * Custom column cell renderer
     * The callback is of the shape of `({ cellData, column, columnIndex, rowData, rowIndex, container }) => *`
     */
